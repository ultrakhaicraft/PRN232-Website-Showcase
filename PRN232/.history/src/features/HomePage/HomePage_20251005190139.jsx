...
>
  ...
  >
    CHƯƠNG 6
    <br />
    <span className="text-4xl tracking-wide md:text-5xl">
      DÂN TỘC VÀ TÔN GIÁO
    </span>
    <br />
    <span className="text-3xl font-bold text-yellow-600 md:text-4xl">
  ...
  <div className="flex justify-center mt-10">
    <motion.img
      src={HinhAnhHCM}
      alt="Hình ảnh Hồ Chí Minh và nền tảng tư tưởng"
      className="w-full max-w-3xl rounded-xl shadow-2xl border-4 border-[#FBC02D]/70"
