...
// Ảnh minh họa (bạn cần lưu trong src/assets/post3/)
...
// import ImgCover4 from "@/assets/post3/cover4.png"; // múa tre dân tộc
    ...
    <div className="min-h-screen bg-[#FAF7E6]">
      <div className="max-w-5xl px-6 py-8 mx-auto">
        ...
        <div className="flex justify-center my-6">
          <img src={ImgCover1} alt="Lễ khánh thành văn hóa dân tộc La Ha" className="w-3/4 rounded-lg shadow" />
          <p className="mt-2 text-sm text-center text-gray-700">Lễ khánh thành Nhà văn hóa cộng đồng dân tộc La Ha</p>
        </div>
...
<div className="flex justify-center my-6">
          <img src={ImgCover2} alt="Lớp học tiếng La Ha" className="w-3/4 rounded-lg shadow" />
          <p className="mt-2 text-sm text-center text-gray-700">Lớp học tiếng La Ha tại huyện Mường La</p>
        </div>
        {/* Content + Image 4 */}
        ...
        {/* <div className="flex justify-center my-6">
          <img src={ImgCover4} alt="Điệu múa truyền thống La Ha" className="w-3/4 rounded-lg shadow" />
          <p className="mt-2 text-sm text-center text-gray-700">Điệu múa truyền thống dân tộc La Ha</p>
        </div> */}
 <div className="flex justify-center my-6">
          <img src={ImgCover3} alt="Điệu múa truyền thống La Ha" className="w-3/4 rounded-lg shadow" />
          <p className="mt-2 text-sm text-center text-gray-700">Sinh hoạt cộng đồng dân tộc La Ha</p>
        </div>
        {/* Youtube Video */}
        ...
        <div className="mt-8">
          ...
          <ul className="pl-6 mt-2 space-y-2 text-blue-600 list-disc">
            <li>
              <a href="https://baotintuc.vn/van-hoa/bao-ton-phat-huy-van-hoa-va-ngon-ngu-dong-bao-dan-toc-la-ha-20230618121320947.htm">
                Bảo tồn, phát huy văn hóa và ngôn ngữ đồng bào dân tộc La Ha
              </a>
            </li>
          </ul>
