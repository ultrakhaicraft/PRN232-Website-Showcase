...
import PostImage from "@/assets/PostImage";
import PieChartTonGiao from "@/assets/PieChartTonGiao.png";
import ImageOfAManDoingStuff from "@/assets/ImageOfAManDoingStuff.jpg";


import ImgCover1 from "@/assets/post5/PieChartTonGiao.png";
import ImgCover3 from "@/assets/post5/ImageOfAManDoingStuff.jpg";
import ImgCover4 from "@/assets/post4/cover4.png";
  ...
  return (
    <div className="min-h-screen bg-[#FAF7E6]">
      <div className="max-w-8xl mx-auto px-6 py-8 bg-[#FAF7E6]">
        ...
        <PostImage src={ImgCover1} caption="Số lượng người theo các tôn giáo theo % (2022-2025)" className="my-6" />
