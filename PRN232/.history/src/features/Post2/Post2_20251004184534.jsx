...
const Post2 = () => {
  ...
  <p className="text-sm text-gray-700">
    Nhà nước đã ban hành nhiều văn bản pháp lý quan trọng...
  </p>
</div>
