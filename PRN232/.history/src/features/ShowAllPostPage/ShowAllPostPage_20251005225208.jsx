...
const ShowAllPostPage = () => {
  ...
  return (
    <div className="bg-[#FFF8E7] min-h-screen py-12 mt-4">
      {/* ===== HEADER ===== */}
      <motion.div
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold mt-4 text-transparent bg-clip-text bg-gradient-to-r from-[#B71C1C] via-[#E53935] to-[#FBC02D] drop-shadow-[0_3px_4px_rgba(0,0,0,0.3)]">
